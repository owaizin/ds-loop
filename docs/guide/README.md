...
Choose the task that matches your team: start a design system, improve a partial system, or maintain an existing one.

- [Set up Design System Loop](install.md): build the package and load the skill.
